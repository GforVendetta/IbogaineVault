...
tags:
  ...
  - topic/phenomenology
key_findings: "COMPREHENSIVE: Narrative review covering pharmacological (NMDA antagonist), cultural (Bwiti worldview), psychological (holotropic consciousness theory) aspects. Questions oneirophrenic classification; proposes ibogaine experience as holotropic state."
doi: "10.1556/2054.2021.00152"
journal: "Journal of Psychedelic Studies"
document_type: review
secondary_categories: [ORANGE, WHITE, PURPLE]
clinical_significance: high
aliases: ["Underwood 2021", "Underwood", "Underwood & Bright 2021"]
source_pdf: "2021/Underwood2021_Narrative_Review_Ibogaine_Literature.pdf"
...
```mermaid
graph TB
    A[Ibogaine Ingestion<br/>15-20 mg/kg] --> B[Phase 1: Acute Phase<br/>1-3 hours post-ingestion]
    B --> C[Phase 2: Reflective Phase<br/>4-8 hours post-ingestion]
    C --> D[Phase 3: Residual Stimulation<br/>12-24 hours post-ingestion]
    
    B --> B1[Physical: Dizziness, ataxia,<br/>nausea, vomiting]
    B --> B2[Psychological: Visual memories,<br/>transcendent beings]
    
    C --> C1[Emotional: Neutral, reflective]
    C --> C2[Focus: Internal experience]
    
    D --> D1[Attention returns to<br/>external environment]
    D --> D2[Intensity lessens,<br/>reduced need for sleep]
```
...
```mermaid
graph LR
    A[Ibogaine] --> B[NMDA Receptor<br/>Antagonism]
    B --> C[Glutamatergic System<br/>Modulation]
    C --> D[Unlearning of Fixed<br/>Perceptions/Responses]
    D --> E[Reduction in Cravings<br/>& Environmental Cues]
    
    A --> F[Multiple Neurotransmitter<br/>Systems]
    F --> G[Sigma Receptors]
    F --> H[Nicotinic Receptors]
    F --> I[Opioid Receptors<br/>mu & kappa]
    F --> J[Dopaminergic System]
    F --> K[Serotonergic System]
```
...
```mermaid
graph TD
    A[Ibogaine Fatalities<br/>Risk Factors] --> B[Co-consumption of<br/>Other Substances]
    A --> C[Genetic Variants]
    A --> D[Cardiotoxicity]
    
    B --> B1[Amphetamine/<br/>Methamphetamine]
    B --> B2[Opioids]
    B --> B3[Methadone]
    
    C --> C1[CYP2D6 Genetic<br/>Variants]
    
    D --> D1[Bradycardia]
    D --> D2[hERG K+ Channel<br/>Blockade]
    D --> D3[QT Interval<br/>Prolongation]
    D --> D4[Torsades de Pointes<br/>Arrythmias]
```
...
```mermaid
graph TB
    A[Bwiti Initiation] --> B[Stage 1: Admission]
    B --> C[Stage 2: Theory]
    C --> D[Stage 3: Exercises]
    D --> E[Stage 4: Practice]
    
    A --> F[Preparation]
    F --> F1[Abstinence from<br/>sex and food]
    F --> F2[Purification of body]
    
    A --> G[Ceremony]
    G --> G1[Ritualistic offering<br/>to forest/trees]
    G --> G2[Confession of<br/>entire past]
    G --> G3[Iboga ingestion<br/>few hectograms powder]
    G --> G4[7-12 hour period<br/>over 3 days/nights]
    
    G --> H[Support]
    H --> H1[Mother & father<br/>figures assist]
    H --> H2[Companions ingest<br/>iboga alongside]
    
    G --> I[Climax Testing]
    I --> I1[Thorn piercing<br/>on 3rd night]
    I --> I2[No reaction =<br/>illumination reached]
```
...
```mermaid
graph LR
    A[Psychedelic-Assisted<br/>Psychotherapy PAP] --> B[Stage 1:<br/>Preparatory<br/>Psychotherapy]
    B --> C[Stage 2:<br/>Moderate-High Dose<br/>Psychedelic +<br/>Therapist Present]
    C --> D[Stage 3:<br/>Integrative<br/>Psychotherapy]
    
    E[Therapeutic Modalities] --> F[Motivational<br/>Interviewing]
    E --> G[Acceptance &<br/>Commitment Therapy]
    E --> H[Individual &<br/>Group Counseling]
```
...
```mermaid
graph TD
    A[Ibogaine Subjective<br/>Effects] --> B[Physical Effects]
    A --> C[Sensory Effects]
    A --> D[Visual Effects]
    A --> E[Cognitive Effects]
    A --> F[Auditory Effects]
    A --> G[Adverse Effects]
    A --> H[Anti-dependency Agent]
    A --> I[Aftereffects]
    
    D --> D1[Open Eye Visuals<br/>OEV]
    D --> D2[Closed Eye Visuals<br/>CEV]
    
    D2 --> D2A[Ancestors &<br/>Entities]
    D2 --> D2B[Sceneries &<br/>Landscapes]
    D2 --> D2C[Horrific<br/>Scenarios]
    
    E --> E1[Self-psychoanalysis<br/>Enhancement]
    E --> E2[Empathy, Love &<br/>Prosocial Behaviour]
    E --> E3[Catharsis]
    E --> E4[Observer Quality]
    E --> E5[Ego Dissolution<br/>Death & Rebirth]
    E --> E6[Spiritual States]
```
...
|------------|--------------|------------------|
| Ibogaine mimics REM sleep | - Similar learning/memory effects proposed<br/>- Dream-like visual content | - Ibogaine suppresses REM sleep (Gonzalez et al., 2018)<br/>- Produces waking state, not sleep state |
...
```mermaid
graph TB
    A[Cultural Approaches to<br/>Consciousness] --> B[Monophasic Cultures]
    A --> C[Polyphasic Cultures]
    
    B --> B1[Western/Industrial<br/>Societies]
    B --> B2[Disregard alternative<br/>states like dreams]
    B --> B3[Focus on external<br/>world adaptation]
    B --> B4[Education skews away<br/>from non-ordinary states]
    B --> B5[Emphasis on consensus<br/>reality]
    
    C --> C1[Pre-industrial<br/>Societies]
    C --> C2[Actively pursue dreams,<br/>trance, meditation]
    C --> C3[Non-ordinary states<br/>integrated into reality]
    C --> C4[Essential for identity<br/>formation]
    C --> C5[Multiple phases of<br/>consciousness valued]
```
...
```mermaid
graph TD
    A[Oneirophrenic Classification] --> B[Problems]
    B --> C[Only describes Phase 1<br/>visual/dream-like state]
    B --> D[Ignores Phase 2<br/>reflective phase]
    B --> E[Ignores Phase 3<br/>residual stimulation]
    B --> F[Inappropriately associated<br/>with sleep deprivation]
    B --> G[Doesn't capture heightened<br/>awareness component]
    
    H[Conclusion] --> I[Classification as<br/>Oneirophrenic is<br/>INADEQUATE]
```
...
```mermaid
graph TB
    A[Holotropic States<br/>Moving Towards Wholeness] --> B[Transformation of<br/>Consciousness]
    A --> C[Dramatic Perceptual<br/>Changes]
    A --> D[Intense & Unusual<br/>Emotions]
    A --> E[Profound Alterations in<br/>Thought Processes]
    
    B --> B1[Invasion of other<br/>dimensions]
    B --> B2[Intense & overwhelming<br/>while remaining oriented]
    
    C --> C1[Transformed visual<br/>perception]
    C --> C2[Images from personal<br/>history]
    C --> C3[Individual & collective<br/>unconscious]
    C --> C4[Insight into nature<br/>of reality]
    C --> C5[Access to mythical<br/>realms]
    
    D --> D1[Ecstatic rapture]
    D --> D2[Bliss & oneness]
    D --> D3[Terror, anger, despair,<br/>guilt]
    
    E --> E1[Spiritual/mystical<br/>content]
    E --> E2[Death & rebirth<br/>experiences]
    E --> E3[Profound psychological<br/>insights]
    E --> E4[Revelations about<br/>reality]
```
...
```mermaid
graph TB
    A[Ibogaine Research<br/>Conclusions] --> B[Pharmacological]
    A --> C[Cultural]
    A --> D[Psychological]
    
    B --> B1[NMDA antagonism likely<br/>mechanism]
    B --> B2[Noribogaine metabolite<br/>contributes to effects]
    B --> B3[RCTs needed for<br/>efficacy confirmation]
    B --> B4[Safety concerns:<br/>cardiotoxicity]
    
    C --> C1[Set-and-setting crucial<br/>in Bwiti tradition]
    C --> C2[Worldview differences<br/>need exploration]
    C --> C3[Traditional vs Western<br/>context understudied]
    
    D --> D1[REM sleep hypothesis<br/>challenged]
    D --> D2[Oneirophrenic classification<br/>inadequate]
    D --> D3[Holotropic state<br/>framework promising]
    D --> D4[Memory retrieval &<br/>mentalisation key]
```
...
```mermaid
graph LR
    A[Future Research<br/>Priorities] --> B[Clinical Trials]
    A --> C[Phenomenology]
    A --> D[Safety Protocols]
    A --> E[Consciousness Studies]
    
    B --> B1[RCTs for efficacy]
    B --> B2[Depression studies]
    B --> B3[Long-term outcomes]
    
    C --> C1[Cross-cultural<br/>comparisons]
    C --> C2[Set-and-setting<br/>effects]
    
    D --> D1[Genetic screening]
    D --> D2[Cardiac monitoring]
    D --> D3[Drug interactions]
    
    E --> E1[Holotropic state<br/>validation]
    E --> E2[Self-concept<br/>transformation]
    E --> E3[Peak experience<br/>correlation]
```
