---
title: "Mania following use of ibogaine: A case series"
authors:
  - "Marta, Cole J."
  - "Ryan, Wesley C."
  - "Kopelowicz, Alex"
...
tags:
  ...
  - topic/psychiatric
  - method/case-series
key_findings: "SAFETY ALERT: 3 cases de novo mania post-ibogaine in patients with no prior bipolar history. Naranjo scale: probable (2 cases) and possible (1). First published reports of ibogaine-induced mania."
...
aliases:
  - "Marta 2015"
  - "Ibogaine Mania Case Series"
  - "Ibogaine-Induced Mania"
secondary_categories:
  - GREEN
  - PURPLE
source_pdf: "2015/Marta2015_Ibogaine_Mania_Case_Reports.pdf"
...
contraindications:
  ...
  - "Prior manic or psychotic episodes"
  - "Concurrent or recent psilocybin use (confounding psychiatric risk)"
...
```mermaid
graph TD
    A["<b>Tabernanthe iboga</b>"] --> B["<b>Ibogaine</b>"]
    B -->|"CYP2D6 metabolism"| D["<b>Noribogaine</b><br/>(longer T½, similar receptor profile)"]

    B & D --> E["Receptor Activity"]

    E --> F["Serotonin System"]
    F --> F1["5-HT2A agonism"]
    F --> F2["5-HT3 agonism"]
    F --> F3["Serotonin reuptake inhibition"]

    E --> G["Glutamate System"]
    G --> G1["NMDA receptor antagonism"]

    E --> H["Opioid System"]
    H --> H1["μ-opioid agonism"]
    H --> H2["κ-opioid agonism"]

    E --> I["Cholinergic System"]
    I --> I1["Nicotinic ACh receptor antagonism"]

    F3 -.->|"Mechanism parallel:<br/>SSRI-induced mania"| J["⚠️ MANIA PATHWAY 1"]
    I1 -.->|"Mechanism parallel:<br/>anticholinergic toxicity mania"| K["⚠️ MANIA PATHWAY 2"]

    style J fill:#ff6b6b,stroke:#333,stroke-width:2px,color:#fff
    style K fill:#ff6b6b,stroke:#333,stroke-width:2px,color:#fff
    style F3 fill:#ffb3b3,stroke:#333
