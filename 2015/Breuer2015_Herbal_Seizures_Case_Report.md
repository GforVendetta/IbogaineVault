---
title: "Herbal seizures - atypical symptoms after ibogaine intoxication: a case report"
authors:
  - "Breuer, Lorenz"
  - "Kasper, Burkhard S."
  - "Schwarze, Bernd"
...
source_pdf: "2015/Breuer2015_Herbal_Seizures_Case_Report.pdf"
...
```mermaid
timeline
    title Ibogaine Intoxication Progression
    section Ingestion
        T+0 hours : Ingestion of 38g Root Bark
                  : 2 doses within 5 mins
    section Onset
        T+1 hour : Visions occur
                 : Visual life memories
        T+1 hr 10 min : Nausea and Vomiting
        T+1 hr 40 min : Muscle tension
                      : Cramps in arms/legs
    section Seizures
        T+10 hours : Generalized Tonic-Clonic Seizure
                   : Found by relatives
        Hospital Admission : Midazolam administered
                           : Recurrent Grand Mal seizures
    section Treatment
        Day 1-2 : Repeated Midazolam
        Day 2 : Levetiracetam (1000 mg) initiated
              : Seizures stopped immediately
    section Recovery
        Day 2 Status : Mild dysarthria, ptosis, psychomotor slowness
        Day 5 : All symptoms disappeared
              : Labs normalized
        Discharge : Discharged seizure-free
...
* **Resolution:** Levetiracetam (1000 mg) was initiated on day two, immediately stopping symptoms. He remained awake with no further neurologic progression (e.g., no tremor, clonus, or hyperreflexia).
...
| **Electroencephalogram** |  |  |  | Irregular alpha rhythm, diffuse theta waves, no focal slowing/epileptiform discharges | Regular alpha rhythm, no focal slowing/epileptiform discharges |  |
| **White blood cell count**  | **11.7** | **10.6** | 6.2 | 5.1 | 4.4 | 4.0–9.4 |
| **Platelet count**  | 248 | 164 | **136** | **127** | 176 | 150–440 |
| **Lymphocyte count** (%) | **5.8** | **11.7** | 25 | 29.4 | 28.0 | 25–40 |
| **Neutrophil count** (%) | **87.8** | **79.2** | 62.4 | 59.9 | 58.8 | 50–75 |
| **Creatinine**  | **1.24** | 0.84 | 0.75 | 0.79 | 0.76 | < 1.2 |
| **Creatine-kinase** (U/l) |  |  | **370** | **234** | 194 | < 190 |
| **C-reactive protein**  | **0.69** |  | **0.71** | 0.39 | 0.35 | 0.0–0.5 |
| **Carbohydrate-deficient transferrin** (%) |  |  |  |  | 1.59 | < 2.6 |
| **Ibogaine concentration** (hair, pg/mg) |  |  | **22** |  |  |  |
| **Noribogaine concentration** (hair, pg/mg) |  |  | **70** |  |  |  |
| **Noribogaine concentration** (urine, ng/mg) |  |  | **9.2** |  |  |  |

Note: Pathological findings are marked in **bold** (represented here by bold text matching the source table's indication). Routine screenings for drugs in urine (benzodiazepines, amphetamines, opiates, cocaine, etc.) were negative.
...
**Authors' contributions:** LM, JMG, HHM, and BSK treated the patient. LB and HHM wrote the manuscript. BS performed forensic/lab analytics. BSK, JK, JMG, and HHM critically revised the manuscript and provided expert opinions .
**Acknowledgements:** Support acknowledged by Deutsche Forschungsgemeinschaft and Friedrich-Alexander-Universität Erlangen-Nürnberg (FAU).
