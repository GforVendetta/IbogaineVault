---
title: "Development of Bioisosteric Iboga-alkaloids as Antinociceptive and Anxiolytic Agents with Neuroprotective Effects"
authors:
  - "Gupta, Abhishek"
  - "Bhattacharya, Tuhin"
  - "Pratihar, Subhamoy"
...
tags:
  ...
  - method/in-vitro
key_findings: "Benzofuran iboga analogues (C2, C4) show antinociceptive/anxiolytic effects with improved cardiac safety. C4 showed no QTc prolongation in rat ECG. Bioisosteric replacement of indole reduces hERG blockade. BDNF/GABA/dopamine elevation."
journal: "Preprint"
publication_date: "2025-01-01"
document_type: preclinical
clinical_significance: high
aliases: ["Gupta 2025", "Benzofuran Iboga Analogues", "C4 Cardioprotective Analog", "Indian Iboga Synthesis"]
source_pdf: "2025/Gupta2025_Benzofuran_Iboga_Analogues.pdf"
...
```mermaid
graph TD
    Start[Start: Hydroquinone / 2-Iodophenol] --> Step1[1. Larock Heteroannulation]
    Step1 --> Step2[2. Vinylic ipso-iodination]
    Step2 --> Step3[3. Removal of silyl group]
    Step3 --> Step4[4. Homoallylic iodination]
    Step4 --> Inter[Di-iodo benzofuran compounds 4 and 10]
    Inter --> Step5[5. Base-mediated alkylation with Compound 5a]
    Step5 --> Inter2[N-alkylated intermediates 11a/11b and 6a/6b]
    Inter2 --> Step6[6. Reductive Heck Coupling]
    Step6 --> Final[Final Products: C1, C2, C3, C4]
```
