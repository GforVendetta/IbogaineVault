...
**Citation:** Mash, D.C., Kovera, C.A., Pablo, J., Tyndale, R.F., Ervin, F.D., Williams, I.C., Singleton, E.G., & Mayor, M. (2000). Ibogaine: Complex pharmacokinetics, concerns for safety, and preliminary efficacy measures. *Annals of the New York Academy of Sciences*, 914, 394–401. https://doi.org/10.1111/j.1749-6632.2000.tb05213.x
...
- Single-dose ibogaine produced significant and sustained reductions in self-reported depression: BDI total scores fell from 16.86 at intake to 2.29 at one-month follow-up (F(3,18)=9.59, p=.0005), representing a shift from clinically significant depressive symptoms to subclinical levels.
...
The core contribution of this paper is its structured measurement of craving and depressive symptoms using validated, multidimensional instruments.

### Depression (Beck Depression Inventory)

Participants entered the programme with clinically significant depressive symptoms (BDI ≥11). Scores declined progressively through treatment and remained low at follow-up:

| Timepoint | BDI Total Score |
|-----------|----------------|
| Pre-ibogaine | 16.86 |
| Post-ibogaine | 10.43 |
| Discharge | 3.00 |
| 1-month follow-up | 2.29 |

*F(3,18)=9.59, p=.0005.* Opiate- and cocaine-dependent subjects did not differ significantly on depression scores.

### Opiate Craving (HCQN-29)

All five subscales showed highly significant reductions following ibogaine treatment, with effects maintained through discharge:

| Subscale | Pre-ibogaine | Post-ibogaine | Discharge | F(3,24) | p |
|----------|-------------|--------------|-----------|---------|------|
| Desire to Use | 4.07 | 1.91 | 1.22 | 58.45 | .0001 |
| Intention to Use | 3.26 | 1.57 | 1.24 | 81.38 | .0001 |
| Anticipation of Positive Outcomes | 4.71 | 2.63 | 1.82 | 52.96 | .0001 |
| Relief of Negative States | 4.88 | 3.67 | 2.85 | 28.33 | .0001 |
| Lack of Control | 4.18 | 3.34 | 2.81 | 15.98 | .0001 |

Lower subscale means indicate less craving. All post-ibogaine means differed from pre-ibogaine at p<.05.

### Cocaine Craving (CCQN-45)

Three of five subscales reached statistical significance. The non-significant results for Desire to Use and Intention to Use likely reflect floor effects — baseline scores were already low, suggesting that inpatient participants had limited immediate urge to use cocaine at the time of assessment:

| Subscale | Pre-ibogaine | Post-ibogaine | Discharge | F(2,10) | p |
|----------|-------------|--------------|-----------|---------|------|
| Desire to Use | 1.45 | 1.10 | 1.10 | 1.22 | ns |
| Intention to Use | 1.60 | 1.38 | 1.29 | 0.97 | ns |
| Anticipation of Positive Outcomes | 2.32 | 1.29 | 1.38 | 3.74 | .05 |
| Relief of Negative States | 3.10 | 1.41 | 1.86 | 15.26 | .0005 |
| Lack of Control | 4.00 | 3.06 | 3.19 | 10.76 | .002 |

Lower subscale means indicate less craving. At one-month follow-up, subjects reported continued diminished craving for both cocaine and opiates, though these data were not tabulated.
...
- [Glue2015_Ibogaine_CYP2D6_Activity](../2015/Glue2015_Ibogaine_CYP2D6_Activity.md) — CYP2D6 polymorphism impact on metabolism
- [Alper2012_Ibogaine_Fatalities](../2012/Alper2012_Ibogaine_Fatalities.md) — Safety implications of PK variability documented here
- [Knuijver2024_Pharmacokinetics_Pharmacodynamics_Ibogaine_OUD_Patients](../2024/Knuijver2024_Pharmacokinetics_Pharmacodynamics_Ibogaine_OUD_Patients.md) — Modern PK/PD in OUD patients
