---
title: "Pangea Biomedics Emergency Equipment & Medications List"
authors:
  - "Wilkins, Clare"
year: 2025
category: GREEN
...
aliases:
  - "Pangea Red Cart"
  - "Pangea Emergency Equipment"
key_findings: "Comprehensive crash cart contents for ibogaine treatment settings; includes cardiac monitoring, resuscitation equipment, ACLS medications, and IV supplies"
source_pdf: "N/A — internal Pangea document"
...
```mermaid
graph TD
    A[Red Cart / Crash Cart] --> B[Monitoring & Vitals]
    A --> C[Resuscitation & Airway]
    A --> D[Intravenous / IV Access]
    A --> E[Emergency Medications]
    A --> F[Miscellaneous & Safety]

    B --> B1[ECG/EKG]
    B --> B2[BP/Pulse Ox/Temp]
    
    C --> C1[Defibrillator/AED]
    C --> C2[Laryngoscope/ET Tubes]
    
    E --> E1[ACLS Meds]
    E --> E2[Reversal Agents]
