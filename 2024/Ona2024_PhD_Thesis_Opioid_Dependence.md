...
```mermaid
graph TD
    A[Binge/Intoxication] -->|Basal Ganglia| B[Withdrawal/Negative Affect]
    B -->|Extended Amygdala| C[Preoccupation/Anticipation]
    C -->|Prefrontal Cortex| A
...
```mermaid
graph TD
    A[Database Search n=61] --> B[Remove Duplicates n=18]
    B --> C[Full Text Analysis n=23]
    C --> D[Exclude: No adverse events reported n=5]
    C --> E[Included Studies n=18]
...
mindmap
  root((Ibogaine/Noribogaine))
    ...
    Neurotrophic Factors
      BDNF/GDNF: Increased Expression
