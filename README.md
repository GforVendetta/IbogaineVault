...
cardiac_trials = [p for p in papers if p["category"] == "RED" and (p.get("sample_size") or 0) > 20]
```
...
The clinical framework underlying this vault was informed by the practice of Clare Wilkins (Clinical Director, Pangea Biomedics — 800+ ibogaine treatment sessions) and Sarita Wilkins (Therapeutic Integration, Pangea Biomedics).[![DOI](https://zenodo.org/badge/1167860310.svg)](https://doi.org/10.5281/zenodo.19159665)
