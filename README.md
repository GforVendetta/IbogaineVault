...
![Papers](https://img.shields.io/badge/papers-305-brightgreen)
...
**Programmatic access** — download [`papers.json`](papers.json) (all 305 papers, all metadata fields) or [`papers.csv`](papers.csv) (flat export for R, Excel, or pandas). Load into any analysis environment in seconds:
