...
| `VAULT_PRINCIPLES.md` | Design philosophy — 11 architectural principles (6 clinical + 5 methodological) governing vault organisation, clinical accuracy standards, and co-equal category treatment. |
