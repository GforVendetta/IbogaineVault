...
- **QTc prolongation:** 616 ms — severely prolonged, well beyond the 500 ms threshold associated with high torsades de pointes (TdP) risk
- **Ventricular tachyarrhythmias** observed during prolonged monitoring
...
This case is a cornerstone reference for ibogaine cardiac safety protocols. Key clinical implications:
...
- Single case report — cannot establish incidence or dose-response relationship
- No ibogaine/noribogaine plasma level measurements
...
**Figure 1.** Electrocardiogram of the patient, showing ventricular tachyarrhythmias and a prolonged QT interval. 12-lead ECG with leads I, II, III, aVR, aVL, aVF, V1–V6 displayed.
